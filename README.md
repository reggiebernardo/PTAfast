...
See [`residuals_tutorial.ipynb`](https://github.com/reggiebernardo/PTAfast/blob/main/residuals_tutorial.ipynb) for simulation (prefit residuals) of an unpolarized or circularly polarized Gaussian stochastic gravitational wave background in a PTA ([arXiv:2507.15756](https://arxiv.org/abs/2507.15756)).
