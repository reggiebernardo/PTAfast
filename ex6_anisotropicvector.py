...
# v = 0.9, 0.5, 0.1, 
gab10_v1 = Vector(v = 0.9, lm = 50, fD = 1000).get_gab_stokes(l = 2, m = 2, zeta = Zta)
gab10_v2 = Vector(v = 0.5, lm = 50, fD = 1000).get_gab_stokes(l = 2, m = 2, zeta = Zta)
gab10_v3 = Vector(v = 0.1, lm = 50, fD = 1000).get_gab_stokes(l = 2, m = 2, zeta = Zta)
...
fig, ax = plt.subplots()
ax.plot(Zta*180/np.pi, gab10_v1['QmiU'].real, 'r-', label = r'$v = 0.9$')
ax.plot(Zta*180/np.pi, gab10_v2['QmiU'].real, 'b--', label = r'$v = 0.5$')
ax.plot(Zta*180/np.pi, gab10_v3['QmiU'].real, 'g-.', label = r'$v = 0.1$')
