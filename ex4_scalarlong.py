...
from PTAfast.scalar import ScalarL as SL # scalar longitudinal
# from PTAfast.scalar import ScalarT as ST # scalar transverse

# an example for the scalar longidutinal ORF
...
# calculate ORF of SL
NEorf = SL(lm = lMax, v = 0.5, fD = 500) # v = GW speed, fD = distance
...
plt.title(r'Scalar Longitudinal, $v$ = ' + str(NEorf.v))
fig.set_rasterized(True)
fig.savefig('ex4_scalarlong.pdf', dpi = 300)